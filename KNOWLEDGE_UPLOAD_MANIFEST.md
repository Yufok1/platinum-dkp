...
Upload these files into the Custom GPT Knowledge area.

## Required

1. `CUSTOM_GPT_INSTRUCTIONS.md`
2. `STATE_MACHINE.md`
3. `PLATINUM_DKP_RULEBOOK.md`
4. `QUEST_CATALOG.md`
5. `DKP_SCORING_TABLE.md`
6. `TREASURY_GOVERNANCE.md`
7. `MARKET_TALK_POLICY.md`
8. `MODERATION_POLICY.md`
...
```text
https://github.com/Yufok1/Brotology-field-guide
```

If a runtime later supports package install, prefer:
