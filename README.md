...
Status: user-provided. Verify live before publishing anywhere that implies official contract identity.
...
- `MARKET_TALK_POLICY.md` keeps chat out of pump coordination.
- `MODERATION_POLICY.md` defines abuse handling.
- `PROPOSAL_TEMPLATE.md` is the governance proposal form.
- `APPEALS_AND_PATCH_NOTES.md` defines review and rule updates.
...
- `WHEAT_FARM_RECEIPT_TEMPLATE.md` defines public-signal joke rebound analytics and receipt format.
